-- -------------------------------------------------------------
-- 
-- File Name: tp_vivado\hdlsrc\main\contador_mem_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: contador_mem_rd
-- Source Path: main/Subsystem/contador_mem_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF contador_mem_rd IS
  ...
  SIGNAL is_contador_mem_rd               : T_state_type_is_contador_mem_rd;  -- uint8
  ...
  SIGNAL is_contador_mem_rd_next          : T_state_type_is_contador_mem_rd;  -- enum type state_type_is_contador_mem_rd (4 enums)
...
BEGIN
  ...
  contador_mem_rd_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      temporalCounter_i1 <= '0';
      cont <= to_unsigned(16#00#, 8);
      is_contador_mem_rd <= IN_inicio;
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        is_contador_mem_rd <= is_contador_mem_rd_next;
        cont <= cont_next;
        temporalCounter_i1 <= temporalCounter_i1_next;
      END IF;
    END IF;
  END PROCESS contador_mem_rd_1_process;

  contador_mem_rd_1_output : PROCESS (cont, is_contador_mem_rd, max_unsigned, reset_1, sumar, temporalCounter_i1)
    VARIABLE temporalCounter_i1_temp : std_logic;
    VARIABLE is_contador_mem_rd_temp : T_state_type_is_contador_mem_rd;
  ...
  BEGIN
    ...
    cont_temp := cont;
    is_contador_mem_rd_temp := is_contador_mem_rd;
    ...
    CASE is_contador_mem_rd IS
      WHEN IN_Espera =>
        IF reset_1 = '1' THEN 
          is_contador_mem_rd_temp := IN_Reset;
          temporalCounter_i1_temp := '0';
        ELSIF sumar = '1' THEN 
          is_contador_mem_rd_temp := IN_incrementa;
          temporalCounter_i1_temp := '0';
        ELSE 
          is_contador_mem_rd_temp := IN_Espera;
        END IF;
      WHEN IN_Reset =>
        ...
        END IF;
      WHEN IN_incrementa =>
        IF (reset_1 OR hdlcoder_to_stdlogic(cont_temp = max_unsigned)) = '1' THEN 
          is_contador_mem_rd_temp := IN_Reset;
          temporalCounter_i1_temp := '0';
    ...
    END CASE;
    cont_next <= cont_temp;
    is_contador_mem_rd_next <= is_contador_mem_rd_temp;
    temporalCounter_i1_next <= temporalCounter_i1_temp;
  END PROCESS contador_mem_rd_1_output;

  contador_mem_rd_1_output1 : PROCESS (cont, is_contador_mem_rd)
  ...
  BEGIN
    ...
    END CASE;
    salida_tmp <= salida1;
  END PROCESS contador_mem_rd_1_output1;
